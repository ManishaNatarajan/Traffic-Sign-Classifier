...
read -p 'Git repository url: ' "https://github.com/ManishaNatarajan/Traffic-Sign-Classifier"
read -p 'Git Username: ' "Manisha Natarajan"
read -p 'Git email: ' "manishanatty@gmail.com"
